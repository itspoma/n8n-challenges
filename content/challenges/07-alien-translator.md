...
## Summary
Використайте ШІ та посібник з вигаданої мови, щоб перекладати інопланетні повідомлення, не приховуючи невідомих слів.

## Concept
Проєктування промптів і структурований результат ШІ
...
## Task
Створіть чат-воркфлоу, який перекладає повідомлення відповідно до наданого організаторами інопланетного словника та граматичної пам’ятки. Повертайте переклад, рівень упевненості та всі невідомі слова, не вигадуючи їхніх значень.

## Bonus Task
Додайте другу перевірку ШІ, яка виконує зворотний переклад результату й знижує рівень упевненості, якщо значення змінюється.
...
## Preparation
- Попросіть у ментора інопланетний словник, граматичну пам’ятку та два офіційні тестові повідомлення.
- Додайте облікові дані моделі ШІ для чату, яку підтримує ваш воркспейс n8n.

## Requirements
- Приймайте інопланетне повідомлення через Chat Trigger.
- Додайте наданий словник і правила граматики до інструкцій моделі.
- Повертайте структуровані поля translation, confidence і unknownWords.
- Перекладайте офіційне відоме повідомлення відповідно до його очікуваного значення англійською.
- Для офіційного загадкового повідомлення зберігайте кожне невідоме слово та знижуйте confidence замість припущень.

## Tips
- Почніть з додавання наданих мовних правил до системних інструкцій.
- Укажіть моделі, що словник є єдиним авторитетним джерелом і вона не повинна вигадувати визначення.
- Додайте до промпту один готовий переклад з матеріалів події як приклад.
- Підключіть Structured Output Parser, щоб кожна відповідь містила ті самі три поля.
- Порівняйте відоме й загадкове тестові повідомлення та перевірте, що unknownWords змінюється правильно.
