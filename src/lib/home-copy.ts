  ...
  en: {
    ...
    gallery: {
      ...
      photoAlts: [
        ...
        "Participants discussing the “Ask Your Google Drive” challenge on a laptop",
        "A hall full of participants raising balloons during the Valencia hackathon",
        "Group photo of hackathon participants with their balloons in front of the stage",
        "An attendee tossing a bunch of balloons into the air near the stage",
        "A laptop showing the “Get City Problems to the Right People” challenge",
        "A balloon being handed over at a team table",
        "Teams working in front of the “Choose your next challenge” screen",
        "Participants at crowded tables holding up their balloons",
        "A smiling participant between two purple balloons while teammates work on a laptop",
        "Participants celebrating with balloons across the València Innovation Capital hall",
        "Teams working on laptops with collected balloons piled on the floor",
      ],
    },
    format: {
      kicker: "The format",
  ...
  es: {
    ...
    gallery: {
      ...
      photoAlts: [
        ...
        "Participantes comentando el reto «Pregúntale a tu Google Drive» en un portátil",
        "Una sala llena de participantes levantando globos durante el hackathon de Valencia",
        "Foto de grupo de los participantes del hackathon con sus globos frente al escenario",
        "Una persona lanzando un ramo de globos al aire junto al escenario",
        "Un portátil con el reto «Lleva los problemas de la ciudad a quien pueda resolverlos»",
        "Entrega de un globo en la mesa de un equipo",
        "Equipos trabajando frente a la pantalla «Elige tu próximo reto»",
        "Participantes en mesas llenas levantando sus globos",
        "Participante sonriendo entre dos globos morados mientras su equipo trabaja en un portátil",
        "Participantes celebrando con globos por toda la sala de València Innovation Capital",
        "Equipos trabajando en sus portátiles con los globos conseguidos amontonados en el suelo",
      ],
    },
    format: {
      kicker: "El formato",
  ...
  uk: {
    ...
    gallery: {
      ...
      photoAlts: [
        ...
        "Учасники обговорюють завдання «Запитай свій Google Drive» біля ноутбука",
        "Повна зала учасників, які піднімають кульки під час хакатону у Валенсії",
        "Спільне фото учасників хакатону з кульками перед сценою",
        "Людина підкидає зв’язку кульок біля сцени",
        "Ноутбук із завданням «Передай міські проблеми тим, хто їх вирішить»",
        "Вручення кульки за столом команди",
        "Команди працюють перед екраном «Оберіть наступне завдання»",
        "Учасники за заповненими столами піднімають свої кульки",
        "Усміхнена людина між двома фіолетовими кульками, поки команда працює за ноутбуком",
        "Учасники святкують із кульками в залі València Innovation Capital",
        "Команди працюють за ноутбуками, а зароблені кульки лежать купою на підлозі",
      ],
    },
    format: {
      kicker: "Формат",
